...
def generaDiccionario(texto: str):
    clientes = {}
    clientes_separados = texto.split("\n")
    
    for cliente in clientes_separados[1:]:
        cliente_separado = cliente.split(";")
        clientes[cliente_separado[0]] = {'nombre': cliente_separado[1], 'email': cliente_separado[2],
                                         'teléfono': cliente_separado[3], 'descuento': float(cliente_separado[4])}
    return clientes

if __name__ == '__main__':
    clientes = generaDiccionario("nif;nombre;email;teléfono;descuento\n01234567L;Luis González;luisgonzalez@mail.com;656343576;12.5\n71476342J;Macarena Ramírez;macarena@mail.com;692839321;8\n63823376M;Juan José Martínez;juanjo@mail.com;664888233;5.2\n98376547F;Carmen Sánchez;carmen@mail.com;667677855;15.7")
    print(clientes)